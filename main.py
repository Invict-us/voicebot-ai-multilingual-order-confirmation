...
try:
    ...
    HAS_ELEVEN = False
    def eleven_set_key(*a, **kw): pass  # no-op stub
...
if HAS_ELEVEN and ELEVENLABS_API_KEY:
    try:
        ...
        pass  # modern elevenlabs SDK doesn't use set_api_key
...
try:
    ...
    twilio_client = Client("DUMMY", "DUMMY")  # placeholder for startup
twilio_validator = RequestValidator(TWILIO_AUTH_TOKEN or "DUMMY")
